...
Either download the contents of this repository and launch the Jupyter notebook file locally or visit this notebook online at [https://mybinder.org/v2/gh/Lindt8/SHAEDIT/master].  Note that this site can be quite slow to load.  Once it has loaded, click the ``SHAEDIT.ipynb`` file/link, which will open the notebook in a new tab, follow the instructions at the top of the page, and enjoy looking at the data with SHAEDIT!
